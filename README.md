...
2. Vector Store Plugins
   ...
   * [`weaviate`](https://github.com/firebase/genkit/tree/main/go/plugins/weaviate) ⭐ 5,750 | 🐛 936 | 🌐 TypeScript | 📅 2026-04-03 - Plugin for Weaviate Vector Stores.
...
1. Core
   * [`genkit-java`](https://github.com/genkit-ai/genkit-java/packages) ⭐ 17 | 🐛 2 | 🌐 Java | 📅 2026-04-03 - An unofficial Java SDK for Genkit, providing Java support for building AI-powered applications.
2. Model / Embedding Plugins
   * [`genkit-plugin-openai`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/openai) ⭐ 17 | 🐛 2 | 🌐 Java | 📅 2026-04-03 - Plugin for OpenAI models (GPT-4o, GPT-4o-mini, etc.) and embeddings.
   * [`genkit-plugin-google-genai`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/google-genai) ⭐ 17 | 🐛 2 | 🌐 Java | 📅 2026-04-03 - Plugin for Google Gemini models and Imagen image generation.
   * [`genkit-plugin-anthropic`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/anthropic) ⭐ 17 | 🐛 2 | 🌐 Java | 📅 2026-04-03 - Plugin for Anthropic Claude models.
   * [`genkit-plugin-aws-bedrock`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/aws-bedrock) ⭐ 17 | 🐛 2 | 🌐 Java | 📅 2026-04-03 - Plugin for AWS Bedrock models (Amazon Nova, Claude, LLaMA, Mistral, etc.).
   * [`genkit-plugin-azure-foundry`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/azure-foundry) ⭐ 17 | 🐛 2 | 🌐 Java | 📅 2026-04-03 - Plugin for Azure AI Foundry models.
   * [`genkit-plugin-xai`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/xai) ⭐ 17 | 🐛 2 | 🌐 Java | 📅 2026-04-03 - Plugin for XAI (x.ai) Grok models.
   * [`genkit-plugin-deepseek`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/deepseek) ⭐ 17 | 🐛 2 | 🌐 Java | 📅 2026-04-03 - Plugin for DeepSeek models.
   * [`genkit-plugin-cohere`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/cohere) ⭐ 17 | 🐛 2 | 🌐 Java | 📅 2026-04-03 - Plugin for Cohere Command models.
   * [`genkit-plugin-mistral`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/mistral) ⭐ 17 | 🐛 2 | 🌐 Java | 📅 2026-04-03 - Plugin for Mistral AI models.
   * [`genkit-plugin-groq`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/groq) ⭐ 17 | 🐛 2 | 🌐 Java | 📅 2026-04-03 - Plugin for Groq ultra-fast inference.
   * [`genkit-plugin-ollama`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/ollama) ⭐ 17 | 🐛 2 | 🌐 Java | 📅 2026-04-03 - Plugin for local Ollama models.
   * [`genkit-plugin-compat-oai`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/compat-oai) ⭐ 17 | 🐛 2 | 🌐 Java | 📅 2026-04-03 - Plugin for any OpenAI-compatible API endpoint.
3. Vector Store Plugins
   * [`genkit-plugin-localvec`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/localvec) ⭐ 17 | 🐛 2 | 🌐 Java | 📅 2026-04-03 - Plugin for local file-based vector store for development.
   * [`genkit-plugin-firebase`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/firebase) ⭐ 17 | 🐛 2 | 🌐 Java | 📅 2026-04-03 - Plugin for Firebase (Firestore vector search, Cloud Functions, telemetry).
   * [`genkit-plugin-weaviate`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/weaviate) ⭐ 17 | 🐛 2 | 🌐 Java | 📅 2026-04-03 - Plugin for Weaviate vector database.
   * [`genkit-plugin-postgresql`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/postgresql) ⭐ 17 | 🐛 2 | 🌐 Java | 📅 2026-04-03 - Plugin for PostgreSQL with pgvector.
   * [`genkit-plugin-pinecone`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/pinecone) ⭐ 17 | 🐛 2 | 🌐 Java | 📅 2026-04-03 - Plugin for Pinecone vector database.
4. Evaluator Plugins
   * [`genkit-plugin-evaluators`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/evaluators) ⭐ 17 | 🐛 2 | 🌐 Java | 📅 2026-04-03 - Plugin for pre-built RAGAS-style evaluators (faithfulness, relevancy, etc.).
5. Other Plugins
   * [`genkit-plugin-jetty`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/jetty) ⭐ 17 | 🐛 2 | 🌐 Java | 📅 2026-04-03 - HTTP server plugin using Jetty 12.
   * [`genkit-plugin-spring`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/spring) ⭐ 17 | 🐛 2 | 🌐 Java | 📅 2026-04-03 - HTTP server plugin using Spring Boot.
   * [`genkit-plugin-mcp`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/mcp) ⭐ 17 | 🐛 2 | 🌐 Java | 📅 2026-04-03 - Plugin for Model Context Protocol (MCP) client integration.
...
* [Genkit GitHub](https://github.com/firebase/genkit) ⭐ 5,750 | 🐛 936 | 🌐 TypeScript | 📅 2026-04-03 - Official GitHub repository for Genkit.
...
* [Genkit Java GitHub](https://github.com/genkit-ai/genkit-java) ⭐ 17 | 🐛 2 | 🌐 Java | 📅 2026-04-03 - Unofficial GitHub repository for Genkit Java.
