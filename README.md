...
1. Vector Store Plugins
   * [`genkitx-convex`](https://github.com/BloomLabsInc/genkit-plugins/tree/main/plugins/convex) ⭐ 182 | 🐛 20 | 🌐 TypeScript | 📅 2026-01-29 - Plugin for Convex Vector Stores.
   * [`genkitx-hnsw`](https://github.com/BloomLabsInc/genkit-plugins/tree/main/plugins/hnsw) ⭐ 182 | 🐛 20 | 🌐 TypeScript | 📅 2026-01-29 - Plugin for HNSW Vector Stores.
   * [`genkitx-qdrant`](https://github.com/qdrant/qdrant-genkit) ⭐ 9 | 🐛 0 | 🌐 TypeScript | 📅 2026-06-12 - Plugin for Qdrant Vector Stores.
   * [`genkitx-voiceflow`](https://github.com/xavidop/genkitx-voiceflow) ⭐ 6 | 🐛 0 | 🌐 TypeScript | 📅 2026-06-11 - Plugin for Voiceflow KB.
   * [`genkitx-redis`](https://github.com/retzd-tech/genkitx-redis) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2025-06-20 - Plugin for Redis Vector Stores.
   * [`genkitx-weaviate`](https://github.com/xavidop/genkitx-weaviate) ⭐ 1 | 🐛 1 | 🌐 TypeScript | 📅 2026-06-12 - Plugin for Weaviate Vector Stores.
...
2. Other Plugins
   * [`genkitx-graph`](https://github.com/TheFireCo/genkit-plugins/tree/main/plugins/graph) ⭐ 182 | 🐛 20 | 🌐 TypeScript | 📅 2026-01-29 - Plugin for building Graph workflows.
...
3. Model / Embedding Plugins
   * [`genkitx-anthropic`](https://github.com/BloomLabsInc/genkit-plugins/tree/main/plugins/anthropic) ⭐ 182 | 🐛 20 | 🌐 TypeScript | 📅 2026-01-29 - Plugin for Anthropic AI APIs.
   * [`genkitx-cohere`](https://github.com/BloomLabsInc/genkit-plugins/tree/main/plugins/cohere) ⭐ 182 | 🐛 20 | 🌐 TypeScript | 📅 2026-01-29 - Plugin for Cohere APIs.
   * [`genkitx-groq`](https://github.com/BloomLabsInc/genkit-plugins/tree/main/plugins/groq) ⭐ 182 | 🐛 20 | 🌐 TypeScript | 📅 2026-01-29 - Plugin for Groq APIs.
   * [`genkitx-mistral`](https://github.com/BloomLabsInc/genkit-plugins/tree/main/plugins/mistral) ⭐ 182 | 🐛 20 | 🌐 TypeScript | 📅 2026-01-29 - Plugin for Mistral AI APIs.
   * [`genkitx-azure-openai`](https://github.com/BloomLabsInc/genkit-plugins/tree/main/plugins/azure-openai) ⭐ 182 | 🐛 20 | 🌐 TypeScript | 📅 2026-01-29 - Plugin for Azure OpenAI APIs.
   * [`genkitx-github`](https://github.com/xavidop/genkitx-github) ⭐ 44 | 🐛 0 | 🌐 TypeScript | 📅 2026-06-12 - Plugin for GitHub Models APIs.
   * [`genkitx-aws-bedrock`](https://github.com/xavidop/genkitx-aws-bedrock) ⭐ 13 | 🐛 1 | 🌐 TypeScript | 📅 2026-06-12 - Plugin for AWS Bedrock APIs.
...
2. Vector Store Plugins
   ...
   * [`weaviate`](https://github.com/firebase/genkit/tree/main/go/plugins/weaviate) ⭐ 6,108 | 🐛 840 | 🌐 TypeScript | 📅 2026-06-12 - Plugin for Weaviate Vector Stores.
...
1. Monitoring Plugin:
   * [`opentelemetry`](https://github.com/xavidop/genkit-opentelemetry-go) ⭐ 12 | 🐛 0 | 🌐 Go | 📅 2026-06-02 - Plugin for OpenTelemetry to monitor Genkit applications.
2. Vector Store Plugins
   * [`qdrant`](https://github.com/qdrant/qdrant-genkit/tree/main/go) ⭐ 9 | 🐛 0 | 🌐 TypeScript | 📅 2026-06-12 - Plugin for Qdrant Vector Stores.
3. Model / Embedding Plugins
...
1. Core
   * [`genkit-java`](https://github.com/genkit-ai/genkit-java/packages) ⭐ 21 | 🐛 4 | 🌐 Java | 📅 2026-06-08 - An unofficial Java SDK for Genkit, providing Java support for building AI-powered applications.
2. Model / Embedding Plugins
   * [`genkit-plugin-openai`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/openai) ⭐ 21 | 🐛 4 | 🌐 Java | 📅 2026-06-08 - Plugin for OpenAI models (GPT-4o, GPT-4o-mini, etc.) and embeddings.
   * [`genkit-plugin-google-genai`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/google-genai) ⭐ 21 | 🐛 4 | 🌐 Java | 📅 2026-06-08 - Plugin for Google Gemini models and Imagen image generation.
   * [`genkit-plugin-anthropic`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/anthropic) ⭐ 21 | 🐛 4 | 🌐 Java | 📅 2026-06-08 - Plugin for Anthropic Claude models.
   * [`genkit-plugin-aws-bedrock`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/aws-bedrock) ⭐ 21 | 🐛 4 | 🌐 Java | 📅 2026-06-08 - Plugin for AWS Bedrock models (Amazon Nova, Claude, LLaMA, Mistral, etc.).
   * [`genkit-plugin-azure-foundry`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/azure-foundry) ⭐ 21 | 🐛 4 | 🌐 Java | 📅 2026-06-08 - Plugin for Azure AI Foundry models.
   * [`genkit-plugin-xai`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/xai) ⭐ 21 | 🐛 4 | 🌐 Java | 📅 2026-06-08 - Plugin for XAI (x.ai) Grok models.
   * [`genkit-plugin-deepseek`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/deepseek) ⭐ 21 | 🐛 4 | 🌐 Java | 📅 2026-06-08 - Plugin for DeepSeek models.
   * [`genkit-plugin-cohere`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/cohere) ⭐ 21 | 🐛 4 | 🌐 Java | 📅 2026-06-08 - Plugin for Cohere Command models.
   * [`genkit-plugin-mistral`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/mistral) ⭐ 21 | 🐛 4 | 🌐 Java | 📅 2026-06-08 - Plugin for Mistral AI models.
   * [`genkit-plugin-groq`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/groq) ⭐ 21 | 🐛 4 | 🌐 Java | 📅 2026-06-08 - Plugin for Groq ultra-fast inference.
   * [`genkit-plugin-ollama`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/ollama) ⭐ 21 | 🐛 4 | 🌐 Java | 📅 2026-06-08 - Plugin for local Ollama models.
   * [`genkit-plugin-compat-oai`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/compat-oai) ⭐ 21 | 🐛 4 | 🌐 Java | 📅 2026-06-08 - Plugin for any OpenAI-compatible API endpoint.
3. Vector Store Plugins
   * [`genkit-plugin-localvec`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/localvec) ⭐ 21 | 🐛 4 | 🌐 Java | 📅 2026-06-08 - Plugin for local file-based vector store for development.
   * [`genkit-plugin-firebase`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/firebase) ⭐ 21 | 🐛 4 | 🌐 Java | 📅 2026-06-08 - Plugin for Firebase (Firestore vector search, Cloud Functions, telemetry).
   * [`genkit-plugin-weaviate`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/weaviate) ⭐ 21 | 🐛 4 | 🌐 Java | 📅 2026-06-08 - Plugin for Weaviate vector database.
   * [`genkit-plugin-postgresql`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/postgresql) ⭐ 21 | 🐛 4 | 🌐 Java | 📅 2026-06-08 - Plugin for PostgreSQL with pgvector.
   * [`genkit-plugin-pinecone`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/pinecone) ⭐ 21 | 🐛 4 | 🌐 Java | 📅 2026-06-08 - Plugin for Pinecone vector database.
4. Evaluator Plugins
   * [`genkit-plugin-evaluators`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/evaluators) ⭐ 21 | 🐛 4 | 🌐 Java | 📅 2026-06-08 - Plugin for pre-built RAGAS-style evaluators (faithfulness, relevancy, etc.).
5. Other Plugins
   * [`genkit-plugin-jetty`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/jetty) ⭐ 21 | 🐛 4 | 🌐 Java | 📅 2026-06-08 - HTTP server plugin using Jetty 12.
   * [`genkit-plugin-spring`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/spring) ⭐ 21 | 🐛 4 | 🌐 Java | 📅 2026-06-08 - HTTP server plugin using Spring Boot.
   * [`genkit-plugin-mcp`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/mcp) ⭐ 21 | 🐛 4 | 🌐 Java | 📅 2026-06-08 - Plugin for Model Context Protocol (MCP) client integration.
...
* [`GCP Cost MCP Server`](https://github.com/nozomi-koborinai/gcp-cost-mcp-server) ⭐ 19 | 🐛 0 | 🌐 Go | 📅 2026-02-22 - An MCP server built with Genkit for Go that enables AI assistants to estimate Google Cloud costs directly, replacing manual use of the GCP Pricing Calculator.
* [`Genkit Kraft`](https://github.com/DEEJ4Y/genkitkraft) ⭐ 4 | 🐛 0 | 🌐 Go | 📅 2026-05-17 - A self-hostable LLM agent platform built on the Genkit Go SDK that lets you configure, test, and deploy AI agents through a visual UI, OpenAI-compatible REST API, and MCP server support for use with AI clients like Claude.
...
* [Genkit GitHub](https://github.com/firebase/genkit) ⭐ 6,108 | 🐛 840 | 🌐 TypeScript | 📅 2026-06-12 - Official GitHub repository for Genkit.
* [Genkit Dart GitHub](https://github.com/genkit-ai/genkit-dart) ⭐ 141 | 🐛 71 | 🌐 Dart | 📅 2026-06-11 - Official GitHub repository for Genkit Dart.
* [Genkit Java GitHub](https://github.com/genkit-ai/genkit-java) ⭐ 21 | 🐛 4 | 🌐 Java | 📅 2026-06-08 - Unofficial GitHub repository for Genkit Java.
