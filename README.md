...
3. Model / Embedding Plugins
   ...
   * [`genkitx-aws-bedrock`](https://github.com/xavidop/genkitx-aws-bedrock) ⭐ 11 | 🐛 1 | 🌐 TypeScript | 📅 2026-02-14 - Plugin for AWS Bedrock APIs.
...
2. Vector Store Plugins
   ...
   * [`weaviate`](https://github.com/firebase/genkit/tree/main/go/plugins/weaviate) ⭐ 5,501 | 🐛 872 | 🌐 Python | 📅 2026-02-15 - Plugin for Weaviate Vector Stores.
...
1. Monitoring Plugin:
   * [`opentelemetry`](https://github.com/xavidop/genkit-opentelemetry-go) ⭐ 9 | 🐛 0 | 🌐 Go | 📅 2026-02-09 - Plugin for OpenTelemetry to monitor Genkit applications.
2. Vector Store Plugins
...
* [Genkit GitHub](https://github.com/firebase/genkit) ⭐ 5,501 | 🐛 872 | 🌐 Python | 📅 2026-02-15 - Official GitHub repository for Genkit.
