...
1. Vector Store Plugins
   ...
   * [`genkitx-voiceflow`](https://github.com/xavidop/genkitx-voiceflow) ⭐ 6 | 🐛 1 | 🌐 TypeScript | 📅 2026-05-15 - Plugin for Voiceflow KB.
   * [`genkitx-redis`](https://github.com/retzd-tech/genkitx-redis) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2025-06-20 - Plugin for Redis Vector Stores.
   * [`genkitx-weaviate`](https://github.com/xavidop/genkitx-weaviate) ⭐ 1 | 🐛 0 | 🌐 TypeScript | 📅 2026-05-16 - Plugin for Weaviate Vector Stores.
...
3. Model / Embedding Plugins
   ...
   * [`genkitx-github`](https://github.com/xavidop/genkitx-github) ⭐ 43 | 🐛 1 | 🌐 TypeScript | 📅 2026-05-15 - Plugin for GitHub Models APIs.
   * [`genkitx-aws-bedrock`](https://github.com/xavidop/genkitx-aws-bedrock) ⭐ 13 | 🐛 0 | 🌐 TypeScript | 📅 2026-05-16 - Plugin for AWS Bedrock APIs.
...
2. Vector Store Plugins
   ...
   * [`weaviate`](https://github.com/firebase/genkit/tree/main/go/plugins/weaviate) ⭐ 5,964 | 🐛 810 | 🌐 TypeScript | 📅 2026-05-17 - Plugin for Weaviate Vector Stores.
...
1. Monitoring Plugin:
   * [`opentelemetry`](https://github.com/xavidop/genkit-opentelemetry-go) ⭐ 11 | 🐛 0 | 🌐 Go | 📅 2026-05-11 - Plugin for OpenTelemetry to monitor Genkit applications.
2. Vector Store Plugins
...
1. Core
   * [`genkit-java`](https://github.com/genkit-ai/genkit-java/packages) ⭐ 20 | 🐛 5 | 🌐 Java | 📅 2026-05-14 - An unofficial Java SDK for Genkit, providing Java support for building AI-powered applications.
2. Model / Embedding Plugins
   * [`genkit-plugin-openai`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/openai) ⭐ 20 | 🐛 5 | 🌐 Java | 📅 2026-05-14 - Plugin for OpenAI models (GPT-4o, GPT-4o-mini, etc.) and embeddings.
   * [`genkit-plugin-google-genai`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/google-genai) ⭐ 20 | 🐛 5 | 🌐 Java | 📅 2026-05-14 - Plugin for Google Gemini models and Imagen image generation.
   * [`genkit-plugin-anthropic`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/anthropic) ⭐ 20 | 🐛 5 | 🌐 Java | 📅 2026-05-14 - Plugin for Anthropic Claude models.
   * [`genkit-plugin-aws-bedrock`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/aws-bedrock) ⭐ 20 | 🐛 5 | 🌐 Java | 📅 2026-05-14 - Plugin for AWS Bedrock models (Amazon Nova, Claude, LLaMA, Mistral, etc.).
   * [`genkit-plugin-azure-foundry`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/azure-foundry) ⭐ 20 | 🐛 5 | 🌐 Java | 📅 2026-05-14 - Plugin for Azure AI Foundry models.
   * [`genkit-plugin-xai`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/xai) ⭐ 20 | 🐛 5 | 🌐 Java | 📅 2026-05-14 - Plugin for XAI (x.ai) Grok models.
   * [`genkit-plugin-deepseek`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/deepseek) ⭐ 20 | 🐛 5 | 🌐 Java | 📅 2026-05-14 - Plugin for DeepSeek models.
   * [`genkit-plugin-cohere`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/cohere) ⭐ 20 | 🐛 5 | 🌐 Java | 📅 2026-05-14 - Plugin for Cohere Command models.
   * [`genkit-plugin-mistral`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/mistral) ⭐ 20 | 🐛 5 | 🌐 Java | 📅 2026-05-14 - Plugin for Mistral AI models.
   * [`genkit-plugin-groq`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/groq) ⭐ 20 | 🐛 5 | 🌐 Java | 📅 2026-05-14 - Plugin for Groq ultra-fast inference.
   * [`genkit-plugin-ollama`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/ollama) ⭐ 20 | 🐛 5 | 🌐 Java | 📅 2026-05-14 - Plugin for local Ollama models.
   * [`genkit-plugin-compat-oai`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/compat-oai) ⭐ 20 | 🐛 5 | 🌐 Java | 📅 2026-05-14 - Plugin for any OpenAI-compatible API endpoint.
3. Vector Store Plugins
   * [`genkit-plugin-localvec`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/localvec) ⭐ 20 | 🐛 5 | 🌐 Java | 📅 2026-05-14 - Plugin for local file-based vector store for development.
   * [`genkit-plugin-firebase`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/firebase) ⭐ 20 | 🐛 5 | 🌐 Java | 📅 2026-05-14 - Plugin for Firebase (Firestore vector search, Cloud Functions, telemetry).
   * [`genkit-plugin-weaviate`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/weaviate) ⭐ 20 | 🐛 5 | 🌐 Java | 📅 2026-05-14 - Plugin for Weaviate vector database.
   * [`genkit-plugin-postgresql`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/postgresql) ⭐ 20 | 🐛 5 | 🌐 Java | 📅 2026-05-14 - Plugin for PostgreSQL with pgvector.
   * [`genkit-plugin-pinecone`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/pinecone) ⭐ 20 | 🐛 5 | 🌐 Java | 📅 2026-05-14 - Plugin for Pinecone vector database.
4. Evaluator Plugins
   * [`genkit-plugin-evaluators`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/evaluators) ⭐ 20 | 🐛 5 | 🌐 Java | 📅 2026-05-14 - Plugin for pre-built RAGAS-style evaluators (faithfulness, relevancy, etc.).
5. Other Plugins
   * [`genkit-plugin-jetty`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/jetty) ⭐ 20 | 🐛 5 | 🌐 Java | 📅 2026-05-14 - HTTP server plugin using Jetty 12.
   * [`genkit-plugin-spring`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/spring) ⭐ 20 | 🐛 5 | 🌐 Java | 📅 2026-05-14 - HTTP server plugin using Spring Boot.
   * [`genkit-plugin-mcp`](https://github.com/genkit-ai/genkit-java/tree/main/plugins/mcp) ⭐ 20 | 🐛 5 | 🌐 Java | 📅 2026-05-14 - Plugin for Model Context Protocol (MCP) client integration.
...
* [`GCP Cost MCP Server`](https://github.com/nozomi-koborinai/gcp-cost-mcp-server) ⭐ 16 | 🐛 0 | 🌐 Go | 📅 2026-02-22 - An MCP server built with Genkit for Go that enables AI assistants to estimate Google Cloud costs directly, replacing manual use of the GCP Pricing Calculator.
...
* [Genkit GitHub](https://github.com/firebase/genkit) ⭐ 5,964 | 🐛 810 | 🌐 TypeScript | 📅 2026-05-17 - Official GitHub repository for Genkit.
* [Genkit Dart GitHub](https://github.com/genkit-ai/genkit-dart) ⭐ 133 | 🐛 64 | 🌐 Dart | 📅 2026-05-12 - Official GitHub repository for Genkit Dart.
* [Genkit Java GitHub](https://github.com/genkit-ai/genkit-java) ⭐ 20 | 🐛 5 | 🌐 Java | 📅 2026-05-14 - Unofficial GitHub repository for Genkit Java.
