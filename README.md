...
1. Vector Store Plugins
   ...
   * [`genkitx-voiceflow`](https://github.com/xavidop/genkitx-voiceflow) ⭐ 6 | 🐛 1 | 🌐 TypeScript | 📅 2026-02-17 - Plugin for Voiceflow KB.
   * [`genkitx-redis`](https://github.com/retzd-tech/genkitx-redis) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2025-06-20 - Plugin for Redis Vector Stores.
   * [`genkitx-weaviate`](https://github.com/xavidop/genkitx-weaviate) ⭐ 1 | 🐛 0 | 🌐 TypeScript | 📅 2026-02-16 - Plugin for Weaviate Vector Stores.
...
3. Model / Embedding Plugins
   ...
   * [`genkitx-github`](https://github.com/xavidop/genkitx-github) ⭐ 43 | 🐛 1 | 🌐 TypeScript | 📅 2026-02-16 - Plugin for GitHub Models APIs.
   * [`genkitx-aws-bedrock`](https://github.com/xavidop/genkitx-aws-bedrock) ⭐ 12 | 🐛 2 | 🌐 TypeScript | 📅 2026-02-18 - Plugin for AWS Bedrock APIs.
...
2. Vector Store Plugins
   ...
   * [`weaviate`](https://github.com/firebase/genkit/tree/main/go/plugins/weaviate) ⭐ 5,513 | 🐛 907 | 🌐 Python | 📅 2026-02-18 - Plugin for Weaviate Vector Stores.
...
1. Monitoring Plugin:
   * [`opentelemetry`](https://github.com/xavidop/genkit-opentelemetry-go) ⭐ 9 | 🐛 0 | 🌐 Go | 📅 2026-02-16 - Plugin for OpenTelemetry to monitor Genkit applications.
2. Vector Store Plugins
...
* [`Perplexity CLI`](https://github.com/xavidop/perplexity-cli) ⭐ 0 | 🐛 7 | 🌐 JavaScript | 📅 2026-02-16 - A command-line interface (CLI) tool that leverages Genkit to provide AI-powered answers to user queries by utilizing web search results from Tavily AI simulating how Perplexity works.
...
* [Genkit GitHub](https://github.com/firebase/genkit) ⭐ 5,513 | 🐛 907 | 🌐 Python | 📅 2026-02-18 - Official GitHub repository for Genkit.
