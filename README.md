...
1. Vector Store Plugins
   ...
   * [`genkitx-voiceflow`](https://github.com/xavidop/genkitx-voiceflow) ⭐ 6 | 🐛 1 | 🌐 TypeScript | 📅 2026-02-16 - Plugin for Voiceflow KB.
...
3. Model / Embedding Plugins
   ...
   * [`genkitx-aws-bedrock`](https://github.com/xavidop/genkitx-aws-bedrock) ⭐ 12 | 🐛 0 | 🌐 TypeScript | 📅 2026-02-16 - Plugin for AWS Bedrock APIs.
...
2. Vector Store Plugins
   ...
   * [`weaviate`](https://github.com/firebase/genkit/tree/main/go/plugins/weaviate) ⭐ 5,509 | 🐛 884 | 🌐 Python | 📅 2026-02-17 - Plugin for Weaviate Vector Stores.
...
* [Genkit GitHub](https://github.com/firebase/genkit) ⭐ 5,509 | 🐛 884 | 🌐 Python | 📅 2026-02-17 - Official GitHub repository for Genkit.
