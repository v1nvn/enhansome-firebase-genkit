...
2. Vector Store Plugins
   ...
   * [`weaviate`](https://github.com/firebase/genkit/tree/main/go/plugins/weaviate) ⭐ 5,782 | 🐛 950 | 🌐 TypeScript | 📅 2026-04-10 - Plugin for Weaviate Vector Stores.
...
* [`Genkit AWS Lambda Bedrock`](https://github.com/xavidop/genkit-aws-lambda-bedrock) ⭐ 2 | 🐛 5 | 🌐 TypeScript | 📅 2026-04-12 - A sample project demonstrating how to use Genkit with AWS Lambda and Amazon Bedrock.
...
* [Genkit GitHub](https://github.com/firebase/genkit) ⭐ 5,782 | 🐛 950 | 🌐 TypeScript | 📅 2026-04-10 - Official GitHub repository for Genkit.
